...
void gf_polymul_192x192sh_unreduced (int *h, int *f, int *g, int cut);
void gf_polymul_64x64sh_unreduced (int *h, int *f, int *g, int cut);
...
void gf_polymul_192x192sh_unreduced (int *h, int *f, int *g, int cut) {
  ...
  convert_r2p19(f, ff, 192);
  convert_r2p19(g, gg, 192);
  my_zero_ints(h, 384);
  gf_polymul_NxNsh_r2p19_addto_32(h,ff,gg,192,cut);
}

void gf_polymul_64x64sh_unreduced (int *h, int *f, int *g, int cut) {
  int ff[32], gg[32];

  convert_r2p19(f, ff, 64);
  convert_r2p19(g, gg, 64);
  my_zero_ints(h, 128);
  gf_polymul_NxNsh_r2p19_addto_32(h,ff,gg,64,cut);
}
