...
assert(NN > 0)
assert(NN % 8 == 0)
assert((output_mode == 't') or (output_mode == 'nt'))
...
def eval_input_coefs(arr_name):
	...
	if arr_name == 'c':
		print('  movw.w r2, #4591')
		print('  movw.w r3, #32768')
		print('  movw.w r4, #18015')
		print('  movt.w r4, #14')
	else:
	...
	if arr_name == 'c': barrett_16x2('r9', 'r10', 'r11', 'r4', 'r3', 'r2')

	if arr_name == 'c':
		print('  lsl.w r10, r6, #2')
		print('  bfc.w r10, #16, #2')
	else: print('  and.w r10, r3, r6, lsl #2')
	print('  sadd16.w r10, r10, r5')

	print('  sadd16.w r11, r10, r9')
	print('  ssub16.w r10, r10, r9')
	if arr_name == 'c':
		barrett_16x2('r11', 'r9', 'r12', 'r4', 'r3', 'r2')
		barrett_16x2('r10', 'r9', 'r12', 'r4', 'r3', 'r2')
	...
	if arr_name == 'c': barrett_16x2('r9', 'r6', 'r12', 'r4', 'r3', 'r2')

	if arr_name == 'c':
		print('  lsl.w r12, r7, #2')
		print('  bfc.w r12, #16, #2')
	else: print('  and.w r12, r3, r7, lsl #2')
	print('  sadd16.w r12, r12, r8')
	print('  sadd16.w r7, r7, r8')

	print('  sadd16.w r9, r9, r12')
	if arr_name == 'c': barrett_16x2('r9', 'r6', 'r8', 'r4', 'r3', 'r2')

	print('  ssub16.w r8, r5, r7')
	print('  sadd16.w r7, r5, r7')
	if arr_name == 'c':
		barrett_16x2('r8', 'r5', 'r6', 'r4', 'r3', 'r2')
		barrett_16x2('r7', 'r5', 'r6', 'r4', 'r3', 'r2')
